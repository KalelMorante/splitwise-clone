  ...
  return (
    <div className="flex flex-col pt-16">
      <section className="mt-20 pb-12 space-y-10 md:space-y-20 px-5">
        <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
          ...
          <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed">
            ...
            quikcly. Never worry about who owes who again.
          </p>
        ...
        <div className="container mx-auto max-w-5xl overflow-hidden rounded-xl shadow-xl">
          <div className="gradient p-1 aspect-[16/9]">
            <Image
              ...
              height={720}
              alt="Banner"
              className="rounded-lg mx-auto" // rounds edges and makes image large, horizontal margins auto center
              priority // makes sure it loads first
            />
          </div>
        </div>
      </section>
      ...
      <section id="features" className="bg-gray-50 py-20">
        <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
          <Badge variant="outline" className="bg-green-199 text-green-700">
            Features
          </Badge>
          ...
          <p className="mx-auto mt-3 max-w-[700px] text-gray-500 md:text-xl/relaxed">
            Our platform provides all the tols you need to hadle shared expenses
            with ease.
          </p>
      ...
      <section className="bg-gray-50 py-20">
        <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
          ...
          <div className="mx-auto mt-12 grid max-w-5xl gap-8 md:cols-2 lg:grid-cols-3">
      ...
      <footer className="text-center py-10">Made by Kalel Morante</footer>
    </div>
  );
}
